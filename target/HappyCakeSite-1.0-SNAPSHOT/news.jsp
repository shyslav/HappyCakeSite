                    ...
                    <div class="blog">
                        ...
                        <p>${items.text} </p>
                         <table>
                            <tbody>
                            <tr>
                                <td><time datetime="${items.date}">
                                    <span class="fa fa-calendar"></span>
                                        ${items.date}
                                </time> </td>
                                <td><a href="#"><div class="fa fa-user"></div> HappyCake</a></td>
                            </tr>
                            <tr>
                                <td colspan="1"><div class="fa fa-tag"></div>${items.tegs}</td>
                                <td colspan="2"><a href="/news/like/${items.id}.htm"><div class="fa fa-thumbs-up"></div>${items.view}</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
